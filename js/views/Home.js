...
export function HomeEvents() {
    ...
    imgButton.addEventListener("click", ()=>{
        ...
        if(imgSrc === "/assets/jalopy1.jpg"){
            jalopyImg.setAttribute("src", "/assets/jalopy2.jpg" )
        }

        if(imgSrc === "/assets/jalopy2.jpg"){
            jalopyImg.setAttribute("src", "/assets/jalopy3.jpg" )
        }

        if(imgSrc === "/assets/jalopy3.jpg") {
            jalopyImg.setAttribute("src", "/assets/jalopy1.jpg" )
